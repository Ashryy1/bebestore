...
import { Save, ArrowLeft, Plus, X, Package, Image as ImageIcon, Ruler, Sparkles } from 'lucide-react';
...
export default function NewProductPage() {
    ...
    useEffect(() => {
        fetch('/api/categories')
            ...
            .then(data => {
                setCategories(data);
                if (data.length > 0) updateForm('category', data[0].slug);
            });
    }, []);
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-10">
            ...
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h1 className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white leading-none">New Product</h1>
                    <p className="text-slate-500 dark:text-slate-400 mt-2 font-bold uppercase text-[10px] tracking-[0.2em]">Add to your handcrafted collection</p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        >
                            ...
                            <span className="font-black uppercase tracking-[0.2em]">{loading ? 'Saving...' : 'Publish Product'}</span>
                        </button>
                    </div>
                </div>
            </form>
